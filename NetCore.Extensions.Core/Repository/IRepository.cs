...
namespace NetCore.Extensions.Core.Repository
{
    public interface IRepository<T, in TKey> where T : class
    {
        ...
        Task<T> FindOneAsync(Expression<Func<T, bool>> filterExpression, FindOptions<T> findOptions = null, params Expression<Func<T, dynamic>>[] includes);
    ...
    public class Repository<T, TKey> : IRepository<T, TKey> where T : class
    {
        ...
        public async Task<T> FindOneAsync(Expression<Func<T, bool>> filterExpression, FindOptions<T> findOptions = null, params Expression<Func<T, dynamic>>[] includes)
        {
            using (var context = OpenDbContext())
            {
                IQueryable<T> queryable = context.Set<T>();
